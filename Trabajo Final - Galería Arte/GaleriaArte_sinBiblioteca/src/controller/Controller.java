...
public class Controller {
    ...
    public String importDataFromBinaryFile() {
        Path desktopFolder = m.getUtils().getPathToDesktopFolder();
        ...
        if (Files.exists(desktopFolder)) {
            ...
            try {
                ...
                return "\n\nNFO: carpeta 'datos_figuras' creada en el escritorio.";
            } catch (IOException e) {
                e.printStackTrace();
    ...
    public String importCSV() throws IOException {
        ...
        for (String line : data) {
            ...
            try {
                csvHeight = Float.parseFloat(arg[1]);
            ...
            try {
                csvQuantity = Integer.parseInt(arg[3]);
            } catch (NumberFormatException e) {
                flag = false;
            }

            try {
                csvYear = Integer.parseInt(arg[4]);
            } catch (NumberFormatException e) {
                flag = false;
            }
